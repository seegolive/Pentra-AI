...
{{
  ...
  "payload_pattern":   "concrete payload or request snippet, e.g. ?id=1 OR 1=1 or <script>alert(1)</script> or {{\"alias1\": mutation}}",
...
def _build_h1_record(
    ...
    data: dict[str, Any] = {
        ...
        "payload_pattern": (llm.get("payload_pattern") or "")[:2000] or None,
