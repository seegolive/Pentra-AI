"""add_cve_fields_to_findings

Revision ID: fe72005d78b2
Revises: f91810040c15
Create Date: 2026-05-22 18:31:23.186819
...
revision: str = 'fe72005d78b2'
down_revision: Union[str, Sequence[str], None] = 'f91810040c15'
...
def upgrade() -> None:
    ...
    op.add_column('findings', sa.Column('cve_ids', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment="List of correlated CVE IDs, e.g. ['CVE-2024-1234']"))
    op.add_column('findings', sa.Column('cve_data', postgresql.JSONB(astext_type=sa.Text()), nullable=True, comment='Enriched CVE detail from NVD (first/most severe match)'))


def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('findings', 'cve_data')
